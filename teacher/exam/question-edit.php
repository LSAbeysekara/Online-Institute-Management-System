    ...
    if($em_id_teacher == "0"){
        ...
        if($count1>0){
            ...
            if(isset($_SESSION['ex_id'])){
                ...
                if(isset($_GET['q_id']) && $_GET['q_num']){

                    $q_id01 = $_GET['q_id'];
                    $q_num = $_GET['q_num'];

                }elseif(isset($_SESSION['q_num']) && $_SESSION['q_id']){
...
<body>
    <div class="container-02">
        ...
        <main>            
            ...
            { 
                ...
                <div class="hw-02">
                    <div class="insights-03">
                            ...
                            <?php 
                                if($sn == $q_num){ ?>
                                    <div class="classes active">
                                        <div class="row-03">
                                            <a href="question-edit.php?q_id=<?php echo $q_id; ?>&q_num=<?php echo $sn; ?>">
                        ...
                        <div class="classes add-question">
                            <a href="question.php"><span class="material-symbols-outlined">add</span></a>
                        </div>
                    </div>
                </div>
            <?php
            ...
            <div class="hw">
                <form id="exam-form" method="post" action="update-questions.php">
                    <div class="question">
                        <div class="hw">
                            <h3 style="font-size: 20px;">Question <?php echo $q_num; ?></h3><br>
                            <textarea name="question" class="question-text"><?php echo $question; ?></textarea><br>
                            <div class="answer-options">
                                <div class="hw">
                                    <h3><label for="">Answer 1: </label></h3>
                                    <textarea name="ans_01" class="option"><?php echo $ans_01; ?></textarea><br>
                                </div>
                                <div class="hw">
                                    <h3><label for="">Answer 2: </label></h3>
                                    <textarea name="ans_02" class="option"><?php echo $ans_02; ?></textarea><br>
                                </div>
                                <div class="hw">
                                    <h3><label for="">Answer 3: </label></h3> 
                                    <textarea name="ans_03" class="option"><?php echo $ans_03; ?></textarea><br>
                                </div>
                                <div class="hw">
                                    <h3><label for="">Answer 4: </label></h3>
                                    <textarea name="ans_04" class="option"><?php echo $ans_04; ?></textarea>
                                </div><br>
                                <div class="hw">
                                    <h2 class="header-03"><label for="">Correct answer: </label></h2>
                                    <textarea name="correct_answer" class="option"><?php echo $correct_answer; ?></textarea>
                                </div>
