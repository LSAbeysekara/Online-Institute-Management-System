    ...
    <div class="container-02">
        ...
        <main>
            ...
            <ul>
                ...
                <li><a href="0#" class="active-nav">Grade exams</a></li>
            </ul><br>
            ...
            <h1><strong>GRADE EXAM</strong></h1><br>
                        ...
                        if($count4>0){ 
                            ...
                            if($count3>0){ 
                                ...
                                <tr>
                                    ...
                                    <td><a href="grading_show.php?ex_id=<?php echo $ex_id; ?>" class="btn" style="color: #1E90FF;"><?php echo $ex_title; ?></a></td>
