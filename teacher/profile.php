...
<?php
    ...
    if($em_id_teacher == "0"){
        ...
        $sql10 = "SELECT * FROM employee WHERE em_id='$em_id_teacher'";
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="cont" style="font-size: 14px;">
                                <div class="left">
                                    ...
                                    <?php
                                        if($em_position == "Admin"){ ?>
                                            <input type="text" id="name" name="job" value="Admin" readonly required>
                                        <?php
                                        }else{ ?>
                                            <input type="text" id="name" name="job" value="Teacher" readonly required>
                                        <?php
                                        }
                                    ?>
                                    ...
                                    <input type="datetime-local" value="<?php echo $em_joined; ?>" readonly required>
                                ...
                                <div class="right">
                                    ...
                                    <?php
                                        if($em_position == "Teacher"){ ?>
                                            <label for="bio">Qualfications:</label>
                                            <textarea name="qualification" rows="4" required><?php echo $em_qualification; ?></textarea>
                                        <?php
                                        }
                                    ?>
